    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('lga_admin.profile.update') }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <span class="status-badge status-onboarded me-2">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('lga_admin.dashboard') }}" class="btn btn-secondary">
                            Cancel
                        </a>
                    </div>
                </form>
