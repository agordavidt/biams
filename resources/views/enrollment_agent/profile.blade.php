    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('enrollment.profile.update') }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {{-- LGA Assignment --}}
                            <div class="mb-3">
                                <label class="form-label">Assigned LGA</label>
                                <div>
                                    <span>
                                        {{ $lga->name ?? 'N/A' }}
                                    </span>
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('enrollment.dashboard') }}" class="btn btn-secondary">
                            Cancel
                        </a>
                    </div>
                </form>
