                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" href="#"><i class="ri-check-double-line me-2 align-middle"></i>Onboard</a></li>
                                                    <li><a class="dropdown-item" href="#"><i class="ri-close-circle-line me-2 align-middle"></i>Reject</a></li>
                                                    <li class="dropdown-divider"></li>
                                                    <li><a class="dropdown-item text-danger" href="#"><i class="ri-delete-bin-5-line me-2 align-middle"></i>Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
