                    ...
                    <form id="resource-form" action="{{ route('admin.resources.store') }}" method="POST" x-data="resourceForm()" @submit.prevent="submitForm">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="name" required placeholder="Enter resource name">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="4" required placeholder="Provide a brief description"></textarea>
                        </div>

                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input type="hidden" name="requires_payment" value="0">
                                <input type="checkbox" class="form-check-input" id="requires_payment" name="requires_payment" x-model="requiresPayment" value="1">
                        ...
                        <div class="mb-3" x-show="requiresPayment">
                            ...
                            <input type="number" class="form-control" name="price" step="0.01" min="0" x-model="price" placeholder="Set the fee amount" required>
                        ...
                        <div class="mb-3" x-show="requiresPayment">
                            ...
                            <select class="form-select" x-model="paymentOption" name="payment_option" x-bind:required="requiresPayment">
                                ...
                                <option value="entrasact">Entrasact</option>
                        ...
                        <div x-show="requiresPayment && paymentOption === 'bank_transfer'">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="bank_account_name" placeholder="Enter account name" x-bind:required="paymentOption === 'bank_transfer'">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Bank Account Number</label>
                                <input type="text" class="form-control" name="bank_account_number" placeholder="Enter account number" x-bind:required="paymentOption === 'bank_transfer'">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Bank Name</label>
                                <input type="text" class="form-control" name="bank_name" placeholder="Enter bank name" x-bind:required="paymentOption === 'bank_transfer'">
                            </div>
                        </div>
                        ...
                        <div x-show="requiresPayment && paymentOption === 'entrasact'">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="entrasact_instruction" rows="3" placeholder="Provide guidance for Entrasact payments" x-bind:required="paymentOption === 'entrasact'"></textarea>
                            </div>
                        </div>
                        ...
                        <div x-show="requiresPayment && paymentOption === 'paystack'">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="paystack_instruction" rows="3" placeholder="Provide guidance for Paystack payments" x-bind:required="paymentOption === 'paystack'"></textarea>
                            </div>
                        </div>

                        <div class="mb-4">
                            <h5>Define Application Form Fields</h5>
                            <p class="text-muted">Add fields that users will fill out when applying for this resource.</p>
                            <div>
