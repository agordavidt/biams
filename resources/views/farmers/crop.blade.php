                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="number" step="0.1" class="form-control" id="farm_size" name="farm_size" value="{{ old('farm_size') }}" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" name="land_tenure" required>
                                    ...
                                    <option value="inherited" {{ old('land_tenure') === 'inherited' ? 'selected' : '' }}>Inherited</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" name="farm_location" value="{{ old('farm_location') }}" required>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" for="crop">Crop Cultivated</label>
                                <select class="form-select" name="crop" id="crops" onchange="handleOtherOption()" required>
                            ...
                            <div class="mb-4" id="otherCropField" style="display: none;">
                                ...
                                <input type="text" class="form-control" name="other_crop" id="otherCrop" value="{{ old('other_crop') }}">
                            </div>
                        </div>
                    </div>
