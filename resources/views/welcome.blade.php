...
<head>
    ...
    <link rel="stylesheet" href="/dashboard/css/css/MyStyles.css">
    ...
    <style>
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('/dashboard/images/agro_bg1.jpg');
...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="display-4 fw-bold mb-4">Benue State Smart Agricultural System and Data Management</h1>
            <p class="lead mb-5">Empowering farmers with digital solutions for better agricultural management</p>
            <a href="/login" class="btn btn-primary me-3">Get Started</a>
    ...
    <section class="about-section">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <img src="/dashboard/images/green_beans.jpg" class="about-image" alt="farm_produce">
                </div>
            </div>
        </div>
    </section>
