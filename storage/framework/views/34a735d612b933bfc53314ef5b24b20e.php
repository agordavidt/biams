...
<head>
    ...
    <link href="<?php echo e(asset('dashboard/css/css/slick.css')); ?>" rel="stylesheet">
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mr-auto" style="font-weight: bold; ">
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route(name: 'landing_page')); ?>">Home</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route(name: 'about')); ?>">About</a> </li>
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route(name: 'services')); ?>">Services</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route(name: 'contact')); ?>">Contact</a> </li>
                    </ul>
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route(name: 'login')); ?>">PORTAL</a> </li>
                    ...
                    <div class="row">
                        <div class="col-md-6 pb-5" style="">
                            ...
                            <div class="about-text section-title-2">
                                ...
                                <a href="<?php echo e(route('contact')); ?>" class="btn btn-success btn-lg px-4 me-2">Contact Us</a>
                            </div>
                        </div>
                        <div class="col-md-6 pb-5">
                            ...
                            <div class=""
                                ...
                                <a href="#"></a> <img
                                    src="<?php echo e(asset('dashboard/images/various_farm_illustrations_500.jpg')); ?>"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 text-center">
                            ...
                            <img src="<?php echo e(asset('dashboard/images/agric_0.jpg')); ?>" alt="assorted farm practices"
    ...
    <!--   JS Files Start  -->
    <script src="<?php echo e(asset('/dashboard/js/js/jquery-3.3.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/dashboard/js/js/jquery-migrate-1.4.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/dashboard/js/js/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/dashboard/js/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/dashboard/js/js/owl.carousel.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/dashboard/js/js/jquery.prettyPhoto.js')); ?>"></script>
    <script src="<?php echo e(asset('/dashboard/js/js/slick.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/dashboard/js/js/custom.js')); ?>"></script>
...
<?php /**PATH C:\wamp\www\BDIC\biams\resources\views/about_us.blade.php ENDPATH**/ ?>