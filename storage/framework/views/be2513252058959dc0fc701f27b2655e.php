        ...
        <div class="container text-center" >
            ...
            <?php if(Route::has('login')): ?>
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a class="btn btn-success btn-lg px-4 me-2" href="<?php echo e(route('home')); ?>">Dashboard</a>
                <?php else: ?>
                    <a class="btn btn-success btn-lg px-4 me-2" href="<?php echo e(route('login')); ?>">Login</a>


                    <?php if(Route::has('register')): ?>
                        <a class="btn btn-outline-light btn-lg px-4" href="<?php echo e(route('register')); ?>">Register</a>
                    <?php endif; ?>
                <?php endif; ?>
...
<?php /**PATH C:\wamp\www\BDIC\biams\resources\views/portal.blade.php ENDPATH**/ ?>