...
<head>
   ...
   .powered_by_bdic{
        ...
        .hero-section {
            background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.7)), url('<?php echo e(asset('dashboard/images/farm-background.jpg')); ?>');
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"> <a class="nav-link" href="<?php echo e(route( 'login')); ?>">PORTAL</a> </li>
    ...
    <section class="hero-section">
        <div class="container text-center">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn btn-success btn-lg px-4 me-2">Get Started</a>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="stat-card text-center">
                        ...
                        <img src="<?php echo e(asset('dashboard/images/green_beans.jpg')); ?>" style="border-radius: 1em"
        ...
        <div class="container">
            ...
            <div class="text-center">
                <div class="row">
                    ...
                    <div class="col-md-4">
                         <a href="http://bdic.ng" target="_blank" class="powered_by_bdic">Powered by BDIC <img src="<?php echo e(asset('/dashboard/images/bdic_logo_small.png')); ?>" alt="BDIC"></a>
                    </div>
                </div>
...
<?php /**PATH C:\wamp\www\BDIC\biams\resources\views/welcome.blade.php ENDPATH**/ ?>